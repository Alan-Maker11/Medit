...
export const ADMIN_T = {
  es: {
    ...
    tripsFor: "Viajes del día",
    noTripsForDay: "No hay viajes este día.",
    selectDayHint: "Selecciona un día para ver los viajes.",
    prev: "← Anterior",
    next: "Siguiente →",
    today: "Hoy",
  },
  en: {
    ...
    tripsFor: "Trips for this day",
    noTripsForDay: "No trips on this day.",
    selectDayHint: "Select a day to see its trips.",
    prev: "← Previous",
    next: "Next →",
    today: "Today",
  },
