...
export async function GET(request: Request) {
  ...
  const columns =
    "pickup_address, destination_address, driver_id, vehicle_id, service_id, total_fare, client_phone, trip_type, transportation_mode, waiting_hours, additional_fees, distance_km, duration_minutes";
