  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    try {
      ...
      if (driverAccount.status !== "active") {
        setError("Tu cuenta no está activa. Contacta a tu supervisor.");
        setLoading(false);
        return;
      }
    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-blue-600 to-blue-800 p-4">
      ...
      >
        <div className="mb-6 text-center">
          <h1 className="text-2xl font-bold text-zinc-900 dark:text-white">Medit Conductor</h1>
          <p className="mt-1 text-sm text-zinc-500">Inicia sesión para ver tu itinerario</p>
        </div>
        ...
        <label className="mb-4 flex flex-col gap-1 text-sm font-medium text-zinc-700 dark:text-zinc-300">
          ...
          <input
            ...
            placeholder="tu.correo@medit.com"
        ...
        <p className="mt-6 text-center text-xs text-zinc-500">¿Necesitas ayuda? Contacta a tu supervisor en Medit.</p>
      </form>
    </div>
  );
}
